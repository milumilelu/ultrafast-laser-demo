...
- **commit_sha**: `f2572e21aa11324e4369140c87547236eb53b144`
- 工作树有未提交改动：**是**（51 项）
- 采集时间：2026-09-12T10:56:27+0800
- Python：3.13.14
...
| 检查 | 状态 | 结果 | 说明 |
|---|---|---|---|
| pytest（全量） | `run` | 418 passed in 96.18s (0:01:36) | 通过 |
...
- 退出码：0
- JUnit：`{"tests": 418, "failures": 0, "errors": 0, "skipped": 0, "time_s": 96.033}`
- 尾部输出：
