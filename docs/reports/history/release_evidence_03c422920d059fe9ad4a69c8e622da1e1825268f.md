...
- **commit_sha**: `03c422920d059fe9ad4a69c8e622da1e1825268f`
- 工作树有未提交改动：**是**（2 项）
- 采集时间：2026-09-13T15:34:25+0800
- Python：3.13.14
...
| 检查 | 状态 | 结果 | 说明 |
|---|---|---|---|
| pytest（全量） | `run` | 426 passed in 127.08s (0:02:07) | 通过 |
...
- 退出码：0
- JUnit：`{"tests": 426, "failures": 0, "errors": 0, "skipped": 0, "time_s": 126.783}`
- 尾部输出：
