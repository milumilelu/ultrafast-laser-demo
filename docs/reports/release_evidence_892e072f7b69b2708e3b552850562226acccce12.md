...
- **commit_sha**: `892e072f7b69b2708e3b552850562226acccce12`
- 工作树有未提交改动：**否**
- 采集时间：2026-09-13T15:43:34+0800
- Python：3.13.14
...
| 检查 | 状态 | 结果 | 说明 |
|---|---|---|---|
| pytest（全量） | `run` | 426 passed in 108.22s (0:01:48) | 通过 |
...
- 退出码：0
- JUnit：`{"tests": 426, "failures": 0, "errors": 0, "skipped": 0, "time_s": 108.063}`
- 尾部输出：
